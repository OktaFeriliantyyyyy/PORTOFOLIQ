...
@section('konten')
    ...
    <div class="text-uppercase">{{ GetMetaValue('badgeText') }}</div>
</div>
<div class="fs-3 fw-light text-muted">{{ GetMetaValue('headerSubtitle') }}</div>
<h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">{{ GetMetaValue('headerTitle') }}</span></h1>
